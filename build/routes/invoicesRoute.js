...
router.post("/create_new_invoice", upload.single("invoiceFile"), function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var invoice_file, url, _a, name, address, invoice_number, cleanString, toNumber, newInvoice, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                invoice_file = req.file;
                url = req.protocol + '://' + req.get('host');
                _a = req.body, name = _a.name, address = _a.address, invoice_number = _a.invoice_number;
...
router.get("/invoices", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Invoice.find().sort({ date: "descending" })
...
router.get("/invoice/name/:name", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, Invoice.find({ name: { $regex: cleanString(name) } })
                        .then(function (invoice) {
                        res.send(invoice);
                    })];
            case 2:
...
router.get("/invoice/date/:date", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, Invoice.find({ date: { $gt: new Date(date) } })
                        .then(function (invoice) {
                        res.send(invoice);
                    })];
            case 2:
...
router.delete("/invoice/delete/:number", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, Invoice.deleteOne({ invoice_number: invoice_number })
                        .then(function () {
                        res.send("deleted");
                    })];
            case 2:
